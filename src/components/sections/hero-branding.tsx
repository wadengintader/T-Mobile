...
const CRUMBL_URL = "https://giftclick.org/aff_c?offer_id=4414&aff_id=44723&source=T-Mobile";
    ...
    >
      <div className="relative inline-block animate-float will-change-transform">
            ...
            <div className="relative z-10 w-[240px] sm:w-[320px] mx-auto transition-transform duration-500 group-hover:scale-105">
              <img 
                src="https://i.imgur.com/V3seRuh.png" 
        ...
        <div className="relative">
            ...
            <span className="text-[#e20074]">T-Mobile Rewards</span>
            <div className="flex items-center -ml-1">
              <Gift className="w-6 h-6 text-[#e20074] fill-transparent" />
            </div>
          </h1>
        </div>
        ...
        <div className="flex items-center justify-center gap-2 w-full text-center">
          <Sparkles className="w-3.5 h-3.5 text-[#e20074] shrink-0 animate-sparkle" />
          <p className="text-[13px] sm:text-sm md:text-[15px] text-[#182C54]/90 font-medium leading-relaxed whitespace-nowrap font-poppins">
            Here&apos;s how to claim your <span className="text-[#e20074] font-bold">$1000 gift card</span>
          </p>
          <Sparkles className="w-3.5 h-3.5 text-[#e20074] shrink-0 animate-sparkle" />
        </div>
      </div>
