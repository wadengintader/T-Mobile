...
const steps: Step[] = [
  ...
  },
  {
    ...
    text: "Unlock your T-MOBILE Rewards",
  },
];
      ...
      <div className="relative rounded-[1.5rem] sm:rounded-[2rem] p-2 sm:p-4 bg-white/5 backdrop-blur-md border-2 border-[#e20074]/30 shadow-[0_8px_32_rgb(204, 0, 0)] overflow-hidden group/box transition-all duration-500 hover:border-[#e20074]/50 hover:scale-[1.01]">
        ...
        <div className="relative z-10 space-y-0 sm:space-y-1">
          {steps.map((step, index) => (
            ...
            >
              <div className="relative flex-shrink-0 w-6 h-6 sm:w-7 sm:h-7 flex items-center justify-center rounded-lg sm:rounded-xl bg-white/40 border border-[#e20074]/15 text-[#e20074] group-hover/item:scale-110 group-hover/item:bg-white/60 transition-all duration-300 shadow-sm">
                {step.icon}
              </div>
